      ...
      <div className='wrapper'>
        <header>
          <menu className='menu  --invisible'>
            ...
            {/* <!--                <li className='menu__item'><a className='menu__ref' href='/about'>ABOUT</a></li>--> */}
          </menu>
        ...
        <div className='overlay'>
          <div className='section1'>
            ...
            <h2 className='section1__title'>We build better world of trust for gamers</h2>
          </div>
